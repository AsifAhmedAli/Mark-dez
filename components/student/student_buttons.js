...
import Add_student_Form from "./add_student";
// import Add_income_Head_Form from "./add_income_head";
    ...
    <StyledView>
      <StyledView className="flex-row py-3">
        <StyledView className="mt-1 px-2 basis-1/2">
          ...
          >
            <StyledText className="text-center">Add Student</StyledText>
          </TouchableOpacity>
        </StyledView>
        {/* <StyledView className="mt-1 px-2 basis-1/2">
          <TouchableOpacity
        ...
        <StyledView className="mt-1 px-2 basis-1/2">
          <TouchableOpacity
            onPress={props.data[0].reset_limit}
            className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow"
          >
            <StyledText className="text-center">View Students</StyledText>
          </TouchableOpacity>
        </StyledView>
      </StyledView>
      ...
      >
        {/* <StyledView className="mt-1 px-2 basis-1/2">
          <TouchableOpacity
            onPress={props.data[0].view_income_heads}
            className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow"
          >
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="">
              <ScrollView>
                <Add_student_Form data={setModalVisible} />
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
               <Add_income_Head_Form data={lknlsdf} />
              <Pressable
                className="px-4 mt-3"
                style={styles.submitButton}
