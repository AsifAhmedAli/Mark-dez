...
const Add_section_Form = (props) => {
  ...
  const API_CALL_TO_ADD_SECTION = () => {
    ...
    if (section == "") {
      ...
      var config = {
        method: "post",
        url: "https://mexil.it/chroma_api/add_section.php",
        headers: {
          Authorization:
      ...
      axios(config)
        ...
        .catch(function (error) {
          console.log(error);
          showMessage({
            message: "This Section Name is already Taken!",
            type: "danger",
          });
        });
      setloading1(false);
  ...
  return (
    <View>
      <Text className="text-center"> Add Section </Text>
      <View>
        <TextInput
          style={styles.input}
          value={section}
        ...
        {isloading1 ? (
          ...
          <TouchableOpacity
            ...
            onPress={API_CALL_TO_ADD_SECTION}
          >
