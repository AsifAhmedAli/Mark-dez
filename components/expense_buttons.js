...
import Add_expense_Form from "./add_expense";
...
<StyledView className="mt-1 px-2 basis-1/2">
    <TouchableOpacity onPress={() => setModalVisible(true)} className="bg-white text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
        <StyledText className="text-center">Add Expense</StyledText>
    </TouchableOpacity>
</StyledView>
<StyledView className="mt-1 px-2 basis-1/2">
    <TouchableOpacity onPress={() => lknlsdf(true)} className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
        <StyledText className="text-center">Add Expense Head</StyledText>
    </TouchableOpacity>
</StyledView>
</StyledView>
...
<StyledView className="mt-1 px-2 basis-1/2">
    <TouchableOpacity onPress={props.data[0].reset_limit} className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
        <StyledText className="text-center">View Expenses</StyledText>
    </TouchableOpacity>
</StyledView>
<StyledView className="mt-1 px-2 basis-1/2">
    <TouchableOpacity onPress={props.data[0].view_expense_heads} className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
        <StyledText className="text-center">View Expense Heads</StyledText>
    </TouchableOpacity>
</StyledView>
</StyledView>
